...
public sealed class QueryBuilder : IReadOnlyCollection<KeyValuePair<string, string>>
{ 
    ...
    {
        Count = count;
        _valuePairs = new List<KeyValuePair<string, string>>(count);
    }
    ...
    public QueryBuilder(IReadOnlyCollection<KeyValuePair<string, string>> parameters)
    {
